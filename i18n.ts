...
const resources = {
  ja: {
    translation: {
      ...
      "sendButton": "送信",
      "sendingButton": "送信中...",
      "comprehensiveDisclaimer": "本アプリケーションの応答はAIによって生成されており、医学的、法律的、その他専門的な助言を代替するものではありません。提供される情報は参考としてのみご利用ください。また、本アプリは多言語に対応しておりますが、翻訳の一部は自動生成によるものであり、表現の正確性を保証するものではありません。ご理解のほど、よろしくお願いいたします。",
      ...
      "errorGeneric": "叡智の言葉を紡ぐ際に問題が生じてしまったようだ。しばらくしてから再度試してみてほしい。(GEN_ERR: %s)",
      ...
      "promptSuggestion3": "困難な感情にどう向き合うか？",
      "promptSuggestion4": "本当の自分とは？",
  ...
  en: {
    translation: {
      ...
      "comprehensiveDisclaimer": "Responses from this application are generated by AI and are not a substitute for medical, legal, or other professional advice. Information provided is for reference only. Additionally, while this app supports multiple languages, some translations are auto-generated and their accuracy cannot be guaranteed. Thank you for your understanding.",
      ...
      "errorGeneric": "A problem arose while weaving words of wisdom. Please try again later. (GEN_ERR: %s)",
  ...
  es: {
    translation: {
      ...
      "errorGeneric": "Surgió un problema al tejer palabras de sabiduría. Por favor, inténtalo de nuevo más tarde. (GEN_ERR: %s)",
  ...
  pt: {
    translation: {
      ...
      "sendButton": "Enviar",
      "sendingButton": "Enviando...",
      "comprehensiveDisclaimer": "As respostas desta aplicação são geradas por IA e não substituem aconselhamento médico, jurídico ou outro profissional. As informações fornecidas são apenas para referência. Além disso, embora este aplicativo suporte vários idiomas, algumas traduções são geradas automaticamente e sua precisão не pode ser garantida. Obrigado pela sua compreensão.",
      "disclaimerLinkText": "Aviso Legal",
      "disclaimerModalTitle": "Aviso Legal",
      ...
      "errorGeneric": "Ocorreu um problema ao tecer palavras de sabedoria. Tente novamente mais tarde. (GEN_ERR: %s)",
  ...
  de: {
    translation: {
      ...
      "errorGeneric": "Beim Weben der Worte der Weisheit ist ein Problem aufgetreten. Bitte versuchen Sie es später erneut. (GEN_ERR: %s)",
  ...
  fr: {
    translation: {
      ...
      "errorGeneric": "Un problème est survenu lors du tissage des mots de sagesse. Veuillez réessayer plus tard. (GEN_ERR: %s)",
  ...
  it: {
    translation: {
      ...
      "errorGeneric": "Si è verificato un problema nel tessere parole di saggezza. Si prega di riprovare più tardi. (GEN_ERR: %s)",
  ...
  ru: {
    translation: {
      ...
      "errorGeneric": "Возникла проблема при плетении слов мудрости. Пожалуйста, повторите попытку позже. (GEN_ERR: %s)",
  ...
  hi: {
    translation: {
      ...
      "errorGeneric": "ज्ञान के शब्द बुनते समय एक समस्या उत्पन्न हुई। कृपया बाद में पुनः प्रयास करें। (GEN_ERR: %s)",
  ...
  ar: {
    translation: {
      ...
      "errorGeneric": "ظهرت مشكلة أثناء نسج كلمات الحكمة. يرجى المحاولة مرة أخرى لاحقًا. (GEN_ERR: %s)",
  ...
  bn: {
    translation: {
      ...
      "errorGeneric": "জ্ঞানের কথা বুনতে গিয়ে একটি সমস্যা দেখা দিয়েছে। অনুগ্রহ করে পরে আবার চেষ্টা করুন। (GEN_ERR: %s)",
   ...
   ta: {
    translation: {
      ...
      "errorGeneric": "ஞான வார்த்தைகளை நெய்யும்போது ஒரு சிக்கல் எழுந்தது. தயவுசெய்து பின்னர் மீண்டும் முயற்சிக்கவும். (GEN_ERR: %s)",
  ...
  zh: {
    translation: {
      ...
      "errorGeneric": "在编织智慧之言时出现了问题。请稍后再试。(GEN_ERR: %s)",
  ...
  ko: {
    translation: {
      ...
      "errorGeneric": "지혜의 말씀을 엮는 중에 문제가 발생했습니다. 나중에 다시 시도해 주십시오. (GEN_ERR: %s)",
